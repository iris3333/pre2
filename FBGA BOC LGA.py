...
data = (data[data.Type_FBGA == 1].append(data[data.Type_BOC == 1], ignore_index=True)).append(data[data.Type_LGA == 1], ignore_index=True)
df = data.loc[:, ["Layer2", "PKG_Size_Area", "BF_Pitch", "TR_Width", "MSAP", "Price"]]
